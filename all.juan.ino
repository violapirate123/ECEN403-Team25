...
void loop() {
  ...
  if (light_button_state == HIGH)
  {
    ...
    while (light_button_state == HIGH){ //keep button on
      ...
      /*
      if (temp >= 315F) {}*/
        while (soundfirst() == false && colorlight() == false)
        {
          soundfirst();
          colorlight();
      ...
      /*if ((temp >= 315F) && soundfirst(); == true) || ((temp > 315F) && (colorlight(); == true)){
  ...
  { 
    ...
    while (medium_button_state == HIGH){ //keep button on
      ...
      if (temp == 215){ //we can mess with this i needed a place holder to turn off the wire
       ...
       /* if(temp >= 410){
        while (soundfirst() == false && colormedium() == false)
        {
          //soundfirst();
          //colormedium();
       ...
       if ((temp >= 410F) && soundfirst(); == true) || ((temp > 410F) && (colormedium(); == true)){
